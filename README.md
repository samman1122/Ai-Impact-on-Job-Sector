...
Workforce Data Analysis (EDA Project)

📌 Project Overview

This project focuses on performing Exploratory Data Analysis (EDA) on a workforce dataset to understand patterns in employee productivity, job satisfaction, work environment, and automation risk.

The goal is to extract meaningful insights that can support data-driven business decisions.
...
The analysis shows that the workforce is transitioning toward modern tools while maintaining stable productivity and satisfaction levels. However, automation risk highlights the need for continuous skill development and strategic workforce planning.

📁 Dataset

Source: Kaggle
Domain: Workforce / Job Market Analysis
